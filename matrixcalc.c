...
void cofactor(int mat[10][10], int temp[10][10], int p, int q, int n) { //COFACTOR
    int i = 0, j = 0;
...
void adjoint(int mat[10][10], int adj[10][10], int n) { //ADJOINT
    if (n == 1) {
        adj[0][0] = 1;
        return;
    }
...
void addsubtract(int matA[10][10], int matB[10][10], int result[10][10], int rows, int cols, int isAddition) { //ADDSUB
    for (int i = 0; i < rows; i++) {
        for (int j = 0; j < cols; j++) {
